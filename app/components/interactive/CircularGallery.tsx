...
function autoBind(instance: Record<string, (...args: unknown[]) => unknown>): void {
...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      {
        image: 'images/temple/sum-pratu-thang-khao-than-phra-ubosot.jpg',
        text: ''
      },
      {
      ...
      {
        image: 'images/temple/wat-champa.jpg',
        text: ''
      },
      {
      ...
      {
        image: 'images/temple/wan-santi.jpg',
        text: ''
      },
      {
